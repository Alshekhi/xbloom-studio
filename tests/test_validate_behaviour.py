...
CASES = [
    ...
    ("temp 30 rejected (below 40 floor)", with_pour(0, temperature_c=30), {"pours.0.temperature_c"}),
    ("temp 20 rejected", with_pour(0, temperature_c=20), {"pours.0.temperature_c"}),
    ("temp 40 accepted (floor)", with_pour(0, temperature_c=40), set()),
